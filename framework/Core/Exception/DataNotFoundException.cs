...
namespace Infrabel.ICT.Framework.Exception
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="DataNotFoundException"></see> class.</summary>
        public DataNotFoundException()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="DataNotFoundException"></see> class with serialized data.</summary>
        /// <param name="info">
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DataNotFoundException"></see> class with a specified error
        ///     message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        protected DataNotFoundException(string message) : base(message)
        {
        }
        ...
        /// </param>
        protected DataNotFoundException(string message, System.Exception innerException) : base(message, innerException)
        {
        }
    }
}